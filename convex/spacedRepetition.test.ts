  ...
  describe('calculateRetrievabilityScore', () => {
    describe('new questions (no nextReview)', () => {
      ...
      it('should prioritize newer questions over older ones', () => {
        ...
        const questions = ages.map(age => createMockQuestion({
    ...
    describe('priority ordering', () => {
      ...
      it('should correctly order a mixed queue', () => {
        const questions = [
          { name: 'brand-new', question: createMockQuestion({
            _creationTime: now.getTime(),
            nextReview: undefined
          })},
          { name: '6h-new', question: createMockQuestion({
            _creationTime: now.getTime() - 6 * 3600000,
            nextReview: undefined
          })},
          { name: '24h-new', question: createMockQuestion({
            _creationTime: now.getTime() - 24 * 3600000,
            nextReview: undefined
          })},
          { name: 'very-overdue', question: createMockQuestion({
          ...
          { name: 'slightly-overdue', question: createMockQuestion({
