...
describe('usePollingQuery', () => {
  ...
  it('should call useQuery with initial timestamp', () => {
    ...
    const { result } = renderHook(() => usePollingQuery(mockQuery, mockArgs));
  ...
  it('should update timestamp at specified interval', async () => {
    ...
    renderHook(() => usePollingQuery(mockQuery, mockArgs, intervalMs));
  ...
  it('should clean up interval on unmount', () => {
    ...
    const { unmount } = renderHook(() => usePollingQuery(mockQuery, mockArgs, 5000));
  ...
  it('should handle visibility change listeners correctly', () => {
    ...
    const { unmount } = renderHook(() => usePollingQuery(mockQuery, mockArgs));
