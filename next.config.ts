    ...
    return [
      {
        ...
        headers: [
          ...
          // Control resource loading and prevent XSS
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://vercel.live https://cdn.vercel-insights.com https://va.vercel-scripts.com https://rapid-jawfish-0.clerk.accounts.dev https://challenges.cloudflare.com",
